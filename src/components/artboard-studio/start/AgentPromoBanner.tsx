...
export function AgentPromoBanner({ onStartAgent }: AgentPromoBannerProps) {
  return (
    ...
    >
      <div className="relative flex h-full flex-col gap-3 rounded-[10px] bg-background px-5 py-4">
        <div
          aria-hidden
        ...
        <span
          className={cn(
            buttonVariants(),
            'mt-auto w-fit bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white'
          )}
        >
          Open the agent
