...
const icons: LibraryElementDef[] = [
  ...
  el('icon-money-bag', 'Money Bag', 'M38 4 H62 C64.5 4 65.8 6.2 64.6 8.3 L59 18 H41 L35.4 8.3 C34.2 6.2 35.5 4 38 4 Z M42 22 H58 C74 30 86 46 86 66 C86 84 71 94 50 94 C29 94 14 84 14 66 C14 46 26 30 42 22 Z M47 40 H53 V46 C59 46.75 63.5 50.5 64.25 56.5 H57.5 C56.75 53.5 53.75 51.25 50 51.25 C46.25 51.25 43.25 53.5 43.25 56.5 C43.25 60.25 47 61 51.5 62.5 C57.5 64 65 65.5 65 72.25 C65 78.25 59.75 82 53 82.75 V88 H47 V82.75 C40.25 82 35.75 77.5 35 71.5 H41.75 C42.5 75.25 45.5 77.5 50 77.5 C54.5 77.5 58.25 75.25 58.25 72.25 C58.25 68.5 54.5 67 49.25 65.5 C43.25 64 36.5 62.5 36.5 56.5 C36.5 51.25 41 46.75 47 46 Z', { evenodd: true }),
  ...
  el('icon-chart-line', 'Line Chart', 'M8 8 V92 H92 M22 74 L42 50 L58 62 L84 30', { stroke: 7 }),
  ...
  el('icon-burger', 'Burger', 'M50 12 C28 12 13 25 11 42 C10.6 44.4 12.4 46 15 46 H85 C87.6 46 89.4 44.4 89 42 C87 25 72 12 50 12 Z ' + roundedRectSub(11, 52, 78, 12, 6) + ' ' + roundedRectSub(11, 70, 78, 18, 8)),
  el('icon-wine', 'Wine Glass', 'M30 6 H70 V24 C70 38 61 46 54 48 V78 H66 V86 H34 V78 H46 V48 C39 46 30 38 30 24 Z'),
  el('icon-plate', 'Food Plate', circleSub(50, 50, 44) + circleSub(50, 50, 33) + circleSub(50, 50, 20), { evenodd: true }),
...
const decor: LibraryElementDef[] = [
  ...
  el('decor-equalizer', 'Equalizer Dots', soundBarsSub([12, 30, 56, 88, 64, 40, 70, 34, 14]), { size: { width: 420, height: 200 } }),
