...
/** Portrait cut of the devices scene: copy on top, 3D phones below. */
export const DevicesSceneMobile: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      {/* Real three.js scene filling the lower half */}
      <div
        style={{ position: "absolute", left: 0, bottom: 0, width: 1080, height: 1250 }}
      >
        <Devices3D width={1080} height={1250} layout="tall" />
      </div>
      ...
      <div
        style={{
          position: "absolute",
          left: 96,
          top: 1470 + interpolate(watch, [0, 1], [150, 0]) + watchBob,
