...
- `useTimelineVideo` hands recordings back and forth: idle they keep looping/autoplaying, previewing they are seeked to `trimStart + min(t, playable)` (the export's `sourceTimeAt`) and re-synced only past 0.25s of drift.
