...
| Desktop auth | loopback + PKCE in the system browser under `NEXT_PUBLIC_GOOGLE_DESKTOP_CLIENT_ID`, returns a refresh token | GitHub **device flow**, no secret, no Worker |
